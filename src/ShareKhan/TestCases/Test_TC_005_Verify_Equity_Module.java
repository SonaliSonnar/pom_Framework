...
public class Test_TC_005_Verify_Equity_Module extends TestCore{
	...
	public void isTestExecutable() throws Exception
	{
		...
		if (!Utility.isExecutable("TC_005_Verify_Equity_Module", excel1))
		{
			throw new SkipException("Skiping this TC_005_Verify_Equity_Module test case");
		}
		setup("Firefox");
...
public void verify_Equity_Module(String LogIn_id,String Mpin,String Tpin)
	 {
		try
		{
