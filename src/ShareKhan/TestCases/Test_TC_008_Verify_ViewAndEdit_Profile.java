...
public class Test_TC_008_Verify_ViewAndEdit_Profile extends TestCore {
	@BeforeTest
	public void isTestExecutable() throws Exception
	{
		...
		if (!Utility.isExecutable("TC_008_Verify_ViewAndEdit_Profile", excel1))
		{
			throw new SkipException("Skiping this TC_008_Verify_ViewAndEdit_Profile test case");
		}
		setup("Firefox");
